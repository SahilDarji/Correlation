...
export class CorrelationCalculator {
    ...
    clearResultsAndTable() {
        ...
        if (solutionDiv) solutionDiv.innerHTML = '<p class="text-gray-600">Enter data and click solve to see detailed steps</p>';
    ...
    updateScatterPlot() {
        ...
        if (this.xValues.length >= 2 && this.currentFormulaResults) {
            ...
            if (denominator_m === 0) { // Vertical line
                // Check if Y values also have no variance (single point)
